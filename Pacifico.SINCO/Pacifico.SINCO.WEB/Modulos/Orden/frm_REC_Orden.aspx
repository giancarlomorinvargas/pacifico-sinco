<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="frm_REC_Orden.aspx.cs" Inherits="Pacifico.SINCO.WEB.Modulos.Orden.frm_REC_Orden" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cphHead">
	...
	<script type='text/javascript'>
	    ...
	    function fn_Grabar() {
	        ...
	        //Valida Final
	        if (sError == "") {
	            fn_mdl_confirma("¿Está seguro que desea rechazar la liquidación?",
                                function () {
                                    $("#btnGrabar").click();
                                },
                                null,
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphCuerpo" runat="Server">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="css_tb_titulo">
		...
		<tr>
			<td class="subModulo">Rechazar Liquidación</td>
		</tr>
	</table>
	<!-- FIN TITULO-->
