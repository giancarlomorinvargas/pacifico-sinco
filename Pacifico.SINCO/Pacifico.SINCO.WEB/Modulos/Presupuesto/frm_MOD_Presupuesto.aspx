<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="frm_MOD_Presupuesto.aspx.cs" Inherits="Pacifico.SINCO.WEB.Modulos.Presupuesto.frm_MOD_Presupuesto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphCuerpo" runat="Server">
    ...
    <asp:Button ID="btnGrabar" runat="server" Text="" OnClientClick="return cargarDetallePresupuesto();" OnClick="btnGrabar_Click" ClientIDMode="Static" Style="display: none;" />
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="css_tb_titulo">
					...
					<tr>
						<td class="subModulo">Modificar Presupuestos</td>
					</tr>
				</table>
				<!-- FIN TITULO-->
							...
							<div class="css_tb_cuerpoPanel">
								<table width="100%" border="0" cellpadding="10" cellspacing="0" class="css_tb_formPanel"><tr><td>									
									...
									<fieldset>
                                        ...
                                        <asp:HiddenField ID="MS_Presupuesto_Id" runat="server" ClientIDMode="Static" EnableViewState="false" />
										...
										<table border="0" cellpadding="5" cellspacing="0">
								            ...
								            <tr>
									            ...
									            <td>
										            <input id="txtNumSiniestro" type="text" class="css_frm_inactivo" runat="server" readonly/>
									            </td>
								            </tr>
								            <tr>												
									            <td class="label">
								            ...
								            <tr>
									            ...
									            <td>
										            <input id="txtFecSiniestro" type="text" class="css_frm_inactivo" runat="server" readonly/>
									            </td>
								            </tr>
								            <tr>
									            <td class="label" style="width: 120px;">
									            ...
									            <td>
										            <input id="txtLugar" type="text" class="css_frm_inactivo" runat="server" readonly/>
									            </td>
								            </tr>														
								            <tr>
									            <td class="label" style="width: 120px;">
									            ...
									            <td>
										            <input id="txtNumPoliza" type="text" class="css_frm_inactivo" runat="server" readonly/>
									            </td>
								            </tr>														
								            <tr>
									            <td class="label" style="width: 120px;">
									            ...
									            <td>
										            <input id="txtAsegurado" type="text" class="css_frm_inactivo" runat="server" readonly/>
									            </td>
								            </tr>																											
							            </table>
												
                                        <asp:HiddenField ID="hdnModeloId" runat="server" ClientIDMode="Static" EnableViewState="false" />
                                        <asp:HiddenField ID="hdnMarcaId" runat="server" ClientIDMode="Static" EnableViewState="false" />
									</fieldset>
