...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <div id="rowDetalle" style="display:none;">   
            <table>
                <tr>
                    ...
                    <td>
                        <input id="hdnFichaCargaId" type="hidden" class="inputValue" data-name="MG_FichaCarga_ID"/>
                        <input id="hdnDetalleFichaCargaId" type="hidden" class="inputValue" data-name="MG_FichaCarga_MG_FichaCarga_ID"/>
        ...
        <%: Html.TextBox("detalleFichaCarga", Session["detalleFichaCarga"], new Dictionary<string, object>() { {"id", "txtDetalle"},{ "type", "hidden" } })%>            
        <table id="tblDetalle">
            <thead>
                <tr>
                    <th>
