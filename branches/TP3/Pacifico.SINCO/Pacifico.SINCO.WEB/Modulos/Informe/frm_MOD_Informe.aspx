<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="frm_MOD_Informe.aspx.cs" Inherits="Pacifico.SINCO.WEB.Modulos.Informe.frm_MOD_Informe" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphCuerpo" runat="Server">
    ...
    <asp:Button ID="btnGrabar" runat="server" Text="" OnClientClick="" OnClick="btnGrabar_Click" ClientIDMode="Static" Style="display: none;" />
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="css_tb_titulo">
					...
					<tr>
						<td class="subModulo">Modificar Informe de Accidente Vehicular</td>
					</tr>
				</table>
				<!-- FIN TITULO-->
				...
				<div class="css_tb_cuerpoPanel">
					<table width="100%" border="0" cellpadding="10" cellspacing="0" class="css_tb_formPanel"><tr><td>									
						...
						<fieldset>
                            ...
                            <asp:HiddenField ID="MS_Informe_Accidente_Id" runat="server" ClientIDMode="Static" EnableViewState="false" />
							...
							<table border="0" cellpadding="5" cellspacing="0">
								<tr>
									...
									<td>
										<input id="txtNumInforme" type="text" class="css_frm_inactivo" readonly  ClientIDMode="Static" runat="server" />
