<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="frm_BSQ_Liquidacion.aspx.cs" Inherits="Pacifico.SINCO.WEB.Modulos.Liquidacion.frm_BSQ_Liquidacion" %>
        ...
        function fn_redirect(pUrl) {
            ...
            if (hddCodLiquidacion != "") {
                ...
                if (hddEstado == "<%=Pacifico.SINCO.UTL.Constantes.lEstado_Registrado%>") {
                    ...
                    fn_mdl_alert("Liquidacion no puede ser modificado", null, "VALIDACIONES");
                }
            } else {
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphCuerpo" runat="Server">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="css_tb_titulo">
		<tr>
			...
			<td class="modulo"> Liquidación </td>
			<td rowspan="2" class="botones">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="css_tb_tituloBotones">
					<tr>
						<td>&nbsp;</td>
						<td class="boton">
							<a href="javascript:window.location='frm_AGR_Liquidacion.aspx';">
								<img src="<%=sUrl %>Util/images/iconos/ico_btn_nuevo.jpg" border="0" /><br />
								Registrar
							</a>
						</td>											
						<td class="boton">
							<a href="javascript:fn_redirect('frm_MOD_Liquidacion.aspx');">
								<img src="<%=sUrl %>Util/images/iconos/ico_btn_editar.jpg" border="0" /><br />
								Modificar
							</a>
						</td>
						<td class="boton">
							<a href="javascript:fn_redirectView('frm_CNS_Liquidacion.aspx');">
		...
		<tr>
			<td class="subModulo">Listado de Liquidación Vehicular</td>
		</tr>
	</table>
	<!-- FIN TITULO-->
