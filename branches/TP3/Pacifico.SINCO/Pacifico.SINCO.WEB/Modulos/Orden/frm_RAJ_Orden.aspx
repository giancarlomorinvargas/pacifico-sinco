<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="frm_RAJ_Orden.aspx.cs" Inherits="Pacifico.SINCO.WEB.Modulos.Orden.frm_RAJ_Orden" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cphHead">
	...
	<script type='text/javascript'>
	    ...
	    function fn_Grabar() {
	        ...
	        sTxtMontoDescuento = $("#txtMontoDescuento").val();

	        sTxtMontoCobertura = $("#txtMontoCobertura").val();

	        if (fn_util_trim(sTxtMontoDescuento) == "" || fn_util_trim(sTxtMontoDescuento) == "0") {
	            sError = sError + "   - Debe ingresar el monto de descuento. <br/>";
	        }

	        if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(sTxtMontoDescuento)) {
	            sError = sError + "   - Debe ingresar el un monto válido para el Descuento. <br/>";
	        }

	        if (parseFloat(sTxtMontoDescuento) > parseFloat(sTxtMontoLiquidacion)) {
	            sError = sError + "   - El monto del Descuento no puede exceder al monto de la Liquidacion. <br/>";
	        }
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphCuerpo" runat="Server">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="css_tb_titulo">
		...
		<tr>
			<td class="subModulo">Ajustar Orden de Cobro</td>
		</tr>
	</table>
	<!-- FIN TITULO-->
                        ...
                        <fieldset>
							...
							<table border="0" cellpadding="5" cellspacing="0">
                                ...
                                <tr>												
									...
									<td>
										<input id="txtMontoDescuento" type="text" ClientIDMode="Static" runat="server"/> </td>												
								</tr>
							</table>
